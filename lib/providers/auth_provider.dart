    ...
    try {
      ...
      if (kIsWeb) {
        ...
        final Map<String, String> queryParams = {
          ...
          'response_type': 'code',
          'scope': 'openid profile email offline_access goauthentik.io/api https://www.googleapis.com/auth/contacts.readonly',
      ...
      final result = await _appAuth.authorizeAndExchangeCode(
        AuthorizationTokenRequest(
          ...
          scopes: ['openid', 'profile', 'email', 'offline_access', 'goauthentik.io/api', 'https://www.googleapis.com/auth/contacts.readonly'],
